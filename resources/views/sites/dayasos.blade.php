            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="mission_text">
                        <h4>Kasie Penanganan dan Pemberdayaan Fakmis</h4>
                    </div>
                </div>
                <div class="col-lg-8">
                    <div class="mision_info">
                        <div class="single_mission">
                            <p>Kepala Seksi Penanganan dan Pemberdayaan Fakmis mempunyai tugas melakukan penghimpunan  dan menelaah, menyusun rencana program dan kegiatan, menyiapkan bahan dan melakukan bimbingan teknis dibidang penanganan dan pemberdayaan fakmis. Fungsi Kasie Penanganan dan Pemberdayaan Fakmis diantaranya melaksanakan penghimpunan dan menelaah bahan pedoman pelaksanaan bimbingan dan latihan ketrampilan usaha serta memantau dan menjadikan kegiatan yang terkait dengan penanganan fakir miskin yang meliputi kegiatan pemberdayaan, pendampingan serta fasilitasi kebutuhan sosial ekonomi fakir miskin, wanita rawan sosial ekonomi, keluarga rentan dan komunitas terpencil. Pelaksanaan monitoring, evaluasi dan pelaporan terkait kegiatan yang dilaksanakan dibidang penanganan dan pemberdayaan fakir miskin.
                            </p>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="mission_text">
                                    <h4>Kasie Pemberdayaan Sosial Pengembangan dan Penyelenggaraan Kesejahteraan Sosial</h4>
                                </div>
                            </div>
                        <div class="col-lg-8">
                                <div class="mision_info">
                                    <div class="single_mission">
                                        <p>Kasie Pemberdayaan Sosial Pengembangan dan Penyelenggaraan Kesejahteraan Sosial mempunyai fungsi diantaranta ialah sebagai pelaksanaan penghimpunan dan menelaah bahan pedoman pemberdayaan kelembagaan sosial, pengembangan dan penyelenggaraan kesejahteraan sosial, dalam rangka pelaksanaan pembinaan Karang Taruna, Tenaga Kesejahteraan Sosial ( TKSK ), Pekerja Sosial Masyarakat ( PSM ). Lembaga Kesejahteraan Sosial (LKS), Lembaga Konsultasi Kesejahteraan Keluarga ( LK3 ). Wahana Kesejahteraan Sosial Berbasis Masyarakat ( WKSBM ) dan Organisasi sosial lainnya. 
                                            Serta pelaksanaan monitoring, evaluasi dan pelaporan terkait kegiatan yang dilaksanakan dibidang pemberdayaan kelembagaan sosial, pengembangan dan penyelenggaraan kesejahteraan sosial serta melakukan pembinaan, bimbingan teknis dan pemantauan kegiatan sumbangan sosial, pengumpulan uang dan barang serta undian gratis berhadiah sesuai dengan ketentuan peraturan perundangundangan yang berlaku.</p>
                                    </div>
                                </div>
                            </div>
                         </div>
                         <div class="row">
                            <div class="col-lg-4">
                                <div class="mission_text">
                                    <h4>Kasie Kepahlawanan, Keperintisan, dan Kesetiakawanan Sosial.</h4>
                                </div>
                            </div>
                        <div class="col-lg-8">
                                <div class="mision_info">
                                    <div class="single_mission">
                                        <p>Kasie Kepahlawanan, Keperintisan, dan Kesetiakawanan Sosial mempunyai fungsi diantaranya melaksanakan penghimpunan dan menelaah bahan pedoman kepahlawanan, keperintisan dan kesetiakawanan sosial. Melaksanakan penyusunan rencana program dan kegiatan serta melaksanakan koordinasi kepahlawanan, keperintisan, dan kesetiakawanan sosial, dan melaksanakan monitoring, evaluasi, 
                                            dan pelaporan terkait kegiatan yang dilaksanakan dibidang kepahlawanan, keperintisan, dan kesetiakawanan sosial.</p>
                                    </div>
                                </div>
                            </div>
                         </div>
