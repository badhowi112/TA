            ...
            <div class="row justify-content-center">
                <div class="col-lg-10">
                    <div class="details_info ">
                        <h3 class="wow fadeInDown" data-wow-duration="1s" data-wow-delay=".3s">Belum ada pengumuman</h3>
                    ...
                    <!-- <div class="details_text">
                        <div class="row">
                            <div class="col-lg-6 wow fadeInUp" data-wow-duration="1s" data-wow-delay=".3s">
                                <p>Visi</p>>
                                <p>Terwujudnya Kabupaten Probolinggo yang Sejahtera, Berkeadilan, Mandiri, Berwawasan Lingkungan, dan Berakhlak Mulia bertujuan meningkatkan kesejahteraan seluruh rakyat Kabupaten Probolinggo, bukan untuk segelintir orang tertentu. Kemakmuran Kabupaten Probolinggo yang ingin diwujudkan adalah kesejahteraan yang berkeadilan, mandiri, berwawasan lingkungan dan berahlak mulia. Pembangunan Kabupaten Probolinggo diarahkan untuk meningkatkan perekonomian daerah, daya saing daerah, kualitas kehidupan masyarakat dan penyelenggaran pemerintahan yang baik.</p>
                            </div>
                            <div class="col-lg-6 wow fadeInUp" data-wow-duration="1s" data-wow-delay=".3s">
                                <p>Misi</p>>
                                <p>meningkatkan kualitas kehidupan masyarakat yang berlandaskan nilai-nilai agama “.Oleh karena itu Dinas Sosial Kabupaten Probolinggo berusaha menterjemahkan agenda pembangunan Kabupaten Probolinggo ke dalam beberapa konsep yang lebih jelas dan fokus.</p>
                            </div>
                        </div>
                    </div> -->
                    <!-- <div class="thumbs">
