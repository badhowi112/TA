    ...
    <div class="our_mission_area">
        <div class="container">
                ...
                <div class="col-lg-8">
                    <div class="mision_info">
                        <div class="single_mission">
                            <p>Pelaksanaan penyusunan rencana program, pembinaan organisasi dan tatalaksana, penyelenggaraan dan pengelolaan administrasi umum dan kepegawaian, perencanaan dan keuangan serta barang milik daerah, pengoordinasian dan pengumpulan data penyusuan rencana program dan anggaran serta pengoordinasian penyusunan peraturan perundang-undangan</p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-4">
                    <div class="mission_text">
                        <h4>Bidang Pemberdayaan Sosial  </h4>
                    </div>
                </div>
            <div class="col-lg-8">
                    <div class="mision_info">
                        <div class="single_mission">
                            <p>Perencanaan kerja dibidang pemberdayaan sosial, pelaksanaan koordinasi terkait dengan pembinaan dibidang pemberdayaan sosial meliputi Lembaga Konsultasi Kesejahteraan Keluarga ( LK3 ) dan Pemberdayaan Sosial Komunitas Adat Terpencil ( KAT), potensi sumber kesejahteraan sosial 
                                serta pelaksanaan proses perizinan usaha kesejahteraan sosial sesuai dengan ketentuan perundang-undangan yang berlaku. Serta pelaksanaan pengaturan distribusi atas</p>
                        </div>
                    </div>
                </div>
             </div>
             <div class="row">
                <div class="col-lg-4">
                    <div class="mission_text">
                        <h4>Bidang Perlindungan dan Jaminan Sosial   </h4>
                    </div>
                </div>
            <div class="col-lg-8">
                    <div class="mision_info">
                        <div class="single_mission">
                            <p>Pelaksanaan koordinasi terkait dengan pembinaan dan pengembangan dibidang perlindungan dan jaminan sosial meliputi kesiapsiagaan dan mitigasi, tanggap darurat bencana alam, pemulihan dan penguatan sosial korban bencana alam, kerja sama dan pengelolaan logistik bencana, penyelenggaraan perlindungan dan jaminan sosial bagi anak terlantar, lanjut usia terlantar, penyandang disabilitas fisik, mental yang derajat kedisabilitasnya tergolong berat, serta  eks penderita penyakit kronis yang tergolong berat yang mengalami ketidakmampuan sosial dan ekonomi, serta Penguatan Program Keluarga Harapan, Program Rastra maupun validitas program penerima bantuan iuran jaminan kesehatan, pedoman teknis, identifikasi, asesment serta penjangkauan cepat, konsultasi dan konseling serta intervensi psikososial, mengembangkan pelayanan bimbingan mental sosial dan ketrampilan serta bantuan sosial UEP, reasesment terkait pencegahan, 
                                penanganan dan perlindungan bagi korban bencana sosial, pekerja migran bermasalah dan pemulangan orang terlantar serta pelaksanaan dan pengendalian norma, standar, pedoman dan petunjuk operasional dibidang perlindungan dan jaminan sosial</p>
                        </div>
                    </div>
                </div>
             </div>
             <div class="row">
                <div class="col-lg-4">
                    <div class="mission_text">
                        <h4>Bidang Pelayanan dan Rehabilitasi Sosial</h4>
                    </div>
                </div>
            <div class="col-lg-8">
                    <div class="mision_info">
                        <div class="single_mission">
                            <p>Pada bidang Pelayanan dan Rehabilitasi Sosial mempuyai tugas merencanakan, merumuskan, melaksanakan, koordinasi kegiatan serta pelaksanaan pengawasan, evaluasi dan pelaporan dibidang pelayanan dan Rehabilitasi Sosial. pelaksanaan dan pengendalian norma, standar, pedoman dan petunjuk operasional dibidang pelayanan dan rehabilitasi
                                sosial. fungsi di bidang jaminan sosial kepada anak yatim piatu terlantar, lanjut usia terlantar, penyandang disabilitas fisik, mental, dan fisik mental dan mental yang derajat kedisabilitasnya tergolong berat, serta eks penderita penyakit kronis yang tergolong berat yang mengalami ketidakmampuan sosial, ekonomi, berdasarkan kesesuaian fungsi dilaksanakan oleh bidang rehabilitasi sosial.
                            </p>
                        </div>
                    </div>
                </div>
